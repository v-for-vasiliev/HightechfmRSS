package ru.vasiliev.hightechfmrss.viewstyle.recyclerviewindicator;
...
public class AnyViewIndicator extends LinearLayout {
    ...
    private int mIndicatorBackgroundResId = R.drawable.white_dot_indicator;
    private int mIndicatorUnselectedBackgroundResId = R.drawable.white_dot_indicator;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorBackgroundResId =
                typedArray.getResourceId(R.styleable.AnyViewIndicator_avi_drawable,
                        R.drawable.white_dot_indicator);
        mIndicatorUnselectedBackgroundResId =
                typedArray.getResourceId(R.styleable.AnyViewIndicator_avi_drawable_unselected,
                        mIndicatorBackgroundResId);
        isAnimationEnable = typedArray.getBoolean(R.styleable.AnyViewIndicator_avi_animation_enable,
                true);
    ...
    public void configureIndicator(int indicatorWidth, int indicatorHeight, int indicatorMargin) {
        configureIndicator(indicatorWidth, indicatorHeight, indicatorMargin,
                R.animator.scale_with_alpha, 0, R.drawable.white_dot_indicator, R.drawable.white_dot_indicator);
    }
    ...
    private void checkIndicatorConfig(Context context) {
        ...
        mIndicatorBackgroundResId = (mIndicatorBackgroundResId == 0) ? R.drawable.white_dot_indicator
                : mIndicatorBackgroundResId;
        mIndicatorUnselectedBackgroundResId =
...
//                    onScrollListener.onScrollStateChanged(recyclerView, RecyclerView
// .SCROLL_STATE_IDLE);
//                }
//            });
//        }
...
//    private final RecyclerView.OnScrollListener onScrollListener = new RecyclerView
// .OnScrollListener() {
//        @Override
